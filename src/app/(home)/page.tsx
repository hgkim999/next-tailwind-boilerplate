    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl  lg:text-left">
        ...
        <div className="grid lg:grid-cols-3">
          <ul>
            <li className="mb-1 text-xl">Prettier/ESlint settings</li>
            <ul className="pl-2 opacity-80">
              <li>Organize imports</li>
              <li>Organize Tailwind classes</li>
              <li>Organize JSON keys</li>
              <li>No unused imports and vars</li>
            </ul>
          </ul>
          <ul>
            <li className="mb-1 text-xl">Other settings</li>
            <ul className="pl-2">
              <li>{'Based on Node 20 (LTS soon)'}</li>
              <li>Docker build templates</li>
              <li>Husky pre-commit lint</li>
              <li>SVGR svg to React Component</li>
              <li>Pino Debug Logger</li>
            </ul>
          </ul>
        </div>
      </div>
